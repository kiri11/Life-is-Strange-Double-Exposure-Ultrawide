...
use lis_ultrawide_camera::games::{Plan, plan_double_exposure};
use lis_ultrawide_camera::{hex, hex4};
use lis_ultrawide_camera::pe;
use lis_ultrawide_camera::scan::{Image, Section};
...
fn matches_the_reference_patch_on_the_real_executable() {
    ...
    let plan = plan_double_exposure(&img, lis_ultrawide_camera::games::gate_upper(5120, 2160)).unwrap();
